...
;(function(f) {
    ...
    return (function e(t, n, r) {
            ...
            3: [
                function(_dereq_, module, exports) {
                    ;(function(global) {
                        ...
                        var supportsReferrerPolicy =
                            utils.supportsReferrerPolicy
                        var serializeKeysForMessage =
                            utils.serializeKeysForMessage
                        ...
                        Raven.prototype = {
                            ...
                            config: function(dsn, options) {
                                ...
                                _window.ravenGlobalOptions = globalOptions
                                // merge in options
                                if (options) {
                                ...
                                self.setDSN(dsn)
                                // if (globalOptions.environment === 'production') {
                                //   self._recordPv('production');
                                // } else {
                                //   self._recordPv('test');
                                // }
                                ...
                                globalOptions.ignoreUrls = globalOptions
                                    .ignoreUrls.length
                                    ? joinRegExp(globalOptions.ignoreUrls)
                                    : false
                                globalOptions.whitelistUrls = globalOptions
                                ...
                                globalOptions.maxBreadcrumbs = Math.max(
                                    0,
                                    Math.min(
                                        globalOptions.maxBreadcrumbs || 100,
                                        100
                                    )
                                ...
                                var autoBreadcrumbs =
                                    globalOptions.autoBreadcrumbs
                                if (
                                    {}.toString.call(autoBreadcrumbs) ===
                                    '[object Object]'
                                ) {
                                ...
                                if (
                                    {}.toString.call(instrument) ===
                                    '[object Object]'
                                ) {
                                    instrument = objectMerge(
                                        instrumentDefaults,
                                        instrument
                                    )
                            ...
                            install: function() {
                                ...
                                if (self.isSetup() && !self._isRavenInstalled) {
                                    TraceKit.report.subscribe(function() {
                                        self._handleOnErrorStackInfo.apply(
                                            self,
                                            arguments
                                        )
                                    })
                                ...
                                Error.stackTraceLimit =
                                    self._globalOptions.stackTraceLimit
                                return this
                            },
                            ...
                            setDSN: function(dsn) {
                                ...
                                self._globalSecret =
                                    uri.pass && uri.pass.substr(1)
                                self._globalProject = uri.path.substr(
                                    lastSlash + 1
                                )
                            ...
                            context: function(options, func, args) {
                                ...
                                return this.wrap(options, func).apply(
                                    this,
                                    args
                                )
                            },
                            ...
                            _getCaptureExceptionOptionsFromPlainObject: function(
                                ...
                                options.extra.__serialized__ = serializeException(
                                    ex
                                )
                            ...
                            captureMessage: function(msg, options) {
                                ...
                                var initialCall =
                                    isArray(stack.stack) && stack.stack[1]
                                var fileurl =
                                    (initialCall && initialCall.url) || ''
                                ...
                                if (
                                    ...
                                    var frames = this._prepareFrames(
                                        stack,
                                        options
                                    )
                                    data.stacktrace = {
                            ...
                            captureBreadcrumb: function(obj) {
                                ...
                                if (
                                    ...
                                    var result = this._globalOptions.breadcrumbCallback(
                                        crumb
                                    )
                            ...
                            setBreadcrumbCallback: function(callback) {
                                var original = this._globalOptions
                                    .breadcrumbCallback
                            ...
                            showReportDialog: function(options) {
                                ...
                                var lastEventId =
                                    options.eventId || this.lastEventId()
                                if (!lastEventId) {
                                ...
                                var user =
                                    options.user || this._globalContext.user
                                if (user) {
                                    if (user.name) {
                                ...
                                var globalServer = this._getGlobalServer(
                                    this._parseDSN(dsn)
                                )
                                ...
                                script.async = true
                                script.src =
                                    globalServer + '/api/embed/error-page/' + qs
                                ;(_document.head || _document.body).appendChild(
                                    script
                                )
                            },
                            ...
                            _patchFunctionToString: function() {
                                var self = this
                                self._originalFunctionToString =
                            ...
                            _instrumentBreadcrumbs: function() {
                                var self = this
                                var autoBreadcrumbs = this._globalOptions
                                    .autoBreadcrumbs
            ...
            _document.attachEvent('onkeypress', self._keypressEventHandler());
                                ...
                                if (
                                    ...
                                    _window.onpopstate = function() {
                                        ...
                                        self._captureUrlChange(
                                            self._lastHref,
                                            currentHref
                                        )

                                        if (oldOnPopState) {
                                            return oldOnPopState.apply(
                                                this,
                                                arguments
                                            )
                                        }
                                ...
                                if (
                                    ...
                                    // console
                                    var consoleMethodCallback = function(
                                        msg,
                                        data
                                    ) {
                                        self.captureBreadcrumb({
                            ...
                            _parseDSN: function(str) {
                                ...
                                if (
                                    dsn.pass &&
                                    !this._globalOptions.allowSecretKey
                                ) {
                                    throw new RavenConfigError(
                            ...
                            _prepareFrames: function(stackInfo, options) {
                                ...
                                if (stackInfo.stack && stackInfo.stack.length) {
                                    each(stackInfo.stack, function(i, stack) {
                                        var frame = self._normalizeFrame(
                                            stack,
                                            stackInfo.url
                                        )
                                        if (frame) {
                            ...
                            _setBackoffState: function(request) {
                                ...
                                try {
                                    ...
                                    if (supportsFetch()) {
                                        ...
                                        retry = request.getResponseHeader(
                                            'Retry-After'
                                        )
                                    }
                                ...
                                this._backoffDuration =
                                    retry || this._backoffDuration * 2 || 1000
                            ...
                            _send: function(data) {
                                ...
                                if (isFunction(globalOptions.dataCallback)) {
                                    data =
                                        globalOptions.dataCallback(data) || data
                                }
                                ...
                                if (
                                    isFunction(
                                        globalOptions.shouldSendCallback
                                    ) &&
                                ...
                                if (
                                    typeof globalOptions.sampleRate === 'number'
                                ) {
                                    if (
                                        Math.random() < globalOptions.sampleRate
                                    ) {
                            ...
                            _sanitizeData: function(data) {
                                return sanitize(
                                    data,
                                    this._globalOptions.sanitizeKeys
                                )
                            },
                            ...
                            _sendProcessedPayload: function(data, callback) {
                                ...
                                var exception =
                                    data.exception && data.exception.values[0]
                                ...
                                if (!data.level || data.level === 'error') {
                                    if (
                                        ...
                                        this._recordError('production')
                                    } else {
                                        this._recordError('test')
                                    }
                                }
                                var url = this._globalEndpoint
                                ;(
                                    globalOptions.transport || this._makeRequest
                                ).call(this, {
                                    url: url,
                                    auth: auth,
                                    data: data,
        ...
        request.send(stringify(opts.data)); */
                            ...
                            _recordError: function(env) {
                                var uri = encodeURIComponent(
                                    this._getLocationHref()
                                )
                                var that = this
                                if (env === 'production') {
                                    wx.request({
                                        url:
                                            'https://doctor.qq.com/common/reporter/error?project=' +
                                            that._globalKey +
                                            '&uri=' +
                                            uri +
                                            '&error=1',
                                    ...
                                    wx.request({
                                        url:
                                            'https://common.sparta.html5.qq.com/reporter/error?project=' +
                                            that._globalKey +
                                            '&uri=' +
                                            uri +
                                            '&error=1',
      ...
      */
                                ...
                                if (pageStack && pageStack.length) {
                                    return (
                                        (this &&
                                        this._globalOptions &&
                                        this._globalOptions.domain
                                            ? this._globalOptions.domain + '/'
                                            : '') +
                                        pageStack[pageStack.length - 1].route +
                                        (this._globalOptions.domain
                                            ? '.html'
                                            : '')
                                    )
                        ...
                        Raven.prototype.setReleaseContext =
                            Raven.prototype.setRelease
                ...
                function(_dereq_, module, exports) {
                    ;(function(global) {
                        ...
                        function isSameException(ex1, ex2) {
                            ...
                            if (
                                isBothUndefined(ex1.stacktrace, ex2.stacktrace)
                            ) {
                                return false
                            }
                        ...
                        function sanitize(input, sanitizeKeys) {
                            ...
                            function sanitizeWorker(workerInput) {
                                ...
                                if (isPlainObject(workerInput)) {
                                    return Object.keys(workerInput).reduce(
                                        function(acc, k) {
                                            if (sanitizeRegExp.test(k)) {
                                                acc[k] = sanitizeMask
                                            } else {
                                                acc[k] = sanitizeWorker(
                                                    workerInput[k]
                                                )
                                            }
                                            return acc
    ...
    */
                        ...
                        function getLocationHref() {
                            ...
                            if (pageStack && pageStack.length) {
                                return (
                                    (_window &&
                                    _window.ravenGlobalOptions &&
                                    _window.ravenGlobalOptions.domain
                                        ? _window.ravenGlobalOptions.domain +
                                          '/'
                                        : '') +
                                    pageStack[pageStack.length - 1].route +
                        ...
                        TraceKit.report = (function reportModuleWrapper() {
                            ...
                            function traceKitWindowOnError(
                                ...
                                var exception = utils.isErrorEvent(ex)
                                    ? ex.error
                                    : ex
                                // If 'msg' is ErrorEvent, get real message from inside
                                var message = utils.isErrorEvent(msg)
                                    ? msg.message
                                    : msg
                                ...
                                if (lastExceptionStack) {
                                    ...
                                    stack = TraceKit.computeStackTrace(
                                        exception
                                    )
                                ...
                                if (_oldOnerrorHandler) {
                                    return _oldOnerrorHandler.apply(
                                        this,
                                        arguments
                                    )
                                }
                            ...
                            function processLastException() {
                                ...
                                notifyHandlers.apply(
                                    null,
                                    [_lastExceptionStack, false].concat(
                                        _lastArgs
                                    )
                                )
                            }
                        ...
                        TraceKit.computeStackTrace = (function computeStackTraceWrapper() {
                            ...
                            function computeStackTraceFromStackProp(ex) {
                                ...
                                var parts
                                var element
                                var reference = /^(.*) is undefined$/.exec(
                                    ex.message
                                )
                                ...
                                for (var i = 0, j = lines.length; i < j; ++i) {
                                    if ((parts = chrome.exec(lines[i]))) {
                                        var isNative =
                                            parts[2] &&
                                            parts[2].indexOf('native') === 0 // start of line
                                        var isEval =
                                            parts[2] &&
                                            parts[2].indexOf('eval') === 0 // start of line
                                        if (
                                            isEval &&
                                            (submatch = chromeEval.exec(
                                                parts[2]
                                            ))
                                        ) {
                                        ...
                                        var isEval =
                                            parts[3] &&
                                            parts[3].indexOf(' > eval') > -1
                                        if (
                                            isEval &&
                                            (submatch = geckoEval.exec(
                                                parts[3]
                                            ))
                                        ) {
                            ...
                            function computeStackTraceByWalkingCallerChain(
                                ...
                                for (
                                    var curr =
                                        computeStackTraceByWalkingCallerChain.caller;
                                    curr && !recursion;
                                    curr = curr.caller
                                ) {
                                    if (
                                        curr === computeStackTrace ||
                                        curr === TraceKit.report
                                    ) {
            ...
            8: [
                function(_dereq_, module, exports) {
                    ...
                    function md5cmn(q, a, b, x, s, t) {
                        return safeAdd(
                            bitRotateLeft(
                                safeAdd(safeAdd(a, q), safeAdd(x, t)),
                                s
                            ),
                            b
                        )
